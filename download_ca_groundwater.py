"""
Download all USGS groundwater-level data for California recorder wells.

Fetches, for every California groundwater site with continuous (daily-values)
water-level records:
...
Outputs:
  data/raw/gw_sites_expanded.rdb   expanded site metadata
  data/raw/gw_series_catalog.rdb   series catalog (period of record)
...
HEADERS = {"User-Agent": "CA-groundwater-research/1.0 (contact: evaristo@uga.edu)"}
...
def fetch_catalogs():
    """Refresh the CA groundwater site list and series catalog so newly
